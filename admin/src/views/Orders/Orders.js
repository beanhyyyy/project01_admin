...
import CardMenuOrders from "components/CardMenuOrders";
import CardItemOrdersWarning from "components/CardItemOrdersWarning";
import CardItemOrdersSuccess from "components/CardItemOrdersSuccess";
  ...
  return (
    <SectionTemplate spacing={4}>
      ...
      <SectionTemplate>
        ...
        <CardItemOrdersWarning />

        <CardItemOrdersSuccess />
      </SectionTemplate>
